...
import { AmbientLight, LightingEffect, PostProcessEffect, _SunLight } from '@deck.gl/core/typed'
import type { Effect } from '@deck.gl/core/typed'
...
const INITIAL_SUNLIGHT_STATE = {
  ...
  date: types.compound({
    year: types.number(2025, { range: [2020, 2030] }),
